"""
Constants used by the FatigueSense inference pipeline
"""
...
# Use separate start/end thresholds so small changes near the cutoff do not create extra blink or yawn events
