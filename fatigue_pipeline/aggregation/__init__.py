...
Each module owns one responsibility that ``FeatureAggregator`` previously
fused into a single class:
...
The orchestrator ``FeatureAggregator`` composes these - no business
logic lives in the orchestrator itself.
"""
...
from fatigue_pipeline.aggregation.pose_signal import (
    PoseFeatures,
    PoseSignalBuffer,
